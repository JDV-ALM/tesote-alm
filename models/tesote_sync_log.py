...
class TesoteSyncLog(models.Model):
    ...
    status = fields.Selection([
        ...
        ('warning', 'Warning'),
        ('error', 'Error'),
    ], string='Status', required=True, default='started')
    ...
    records_added = fields.Integer(
        string='Records Added',
        default=0
    )

    records_modified = fields.Integer(
        string='Records Modified',
        default=0
    )

    records_removed = fields.Integer(
        string='Records Removed',
        default=0
    )
    ...
    details = fields.Text(
        string='Details',
        help='Additional information about the sync operation'
    )
    ...
    cursor_before = fields.Char(
        string='Cursor Before',
        help='Sync cursor value before operation'
    )

    cursor_after = fields.Char(
        string='Cursor After',
        help='Sync cursor value after operation'
    )
