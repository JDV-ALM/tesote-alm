...
class TestTesoteAdapter:
    ...
    def test_get_whoami(self, adapter):
        ...
        responses.add(
            ...
            json={"name": "Test Corporation", "environment": "Production"},
            status=200,
        )
    ...
    def test_list_accounts(self, adapter):
        ...
        responses.add(
            ...
            json={
                "accounts": [
                    {"id": "acc-001", "name": "Checking Account"},
                    {"id": "acc-002", "name": "Savings Account"},
                ],
                "page": 1,
                "per_page": 100,
                "total": 2,
    ...
    def test_sync_transactions(self, adapter):
        ...
        # Execute
        result = adapter.sync_transactions(tesote_account_id=account_id, cursor="now", count=100)
