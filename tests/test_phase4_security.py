...
class TestPhase4Security(unittest.TestCase):
    ...
    def test_signature_verification_valid(self):
        ...
        self.webhook_config.verify_signature.assert_called_once_with(payload, timestamp, expected_signature)
    ...
    def test_signature_verification_invalid(self):
        ...
        self.webhook_config.verify_signature.assert_called_once_with(payload, timestamp, invalid_signature)
