...
class TestTesoteSyncLog:
    ...
    def test_sync_log_creation(self, sync_log_model, mock_backend):
        ...
        # Test creation
        log = sync_log_model.create_log(mock_backend, "test_connection")

        sync_log_model.create_log.assert_called_once_with(mock_backend, "test_connection")
    ...
    def test_sync_log_success(self, sync_log_model):
        ...
        mock_log.set_success(records_added=5, api_calls=2)

        mock_log.set_success.assert_called_once_with(records_added=5, api_calls=2)
    ...
    def test_sync_log_progress_update(self, sync_log_model):
        ...
        mock_log.update_progress(details="Syncing account Test Account", api_calls=3)

        mock_log.update_progress.assert_called_once_with(
            details="Syncing account Test Account", api_calls=3
        )
